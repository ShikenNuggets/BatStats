...
pub fn parse_to_url(base_url: &str, args: HashMap<&str, &str>) -> Result<Url, Box<dyn Error>>{
...
pub async fn get_http_result_with_args(base_url: &str, args: HashMap<&str, &str>) -> Result<String, Box<dyn Error>>{
